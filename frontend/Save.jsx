      ...
      <div class="row">
        <div class="col-md-6 col-lg-4">
          <div class="card border-light bg-light text-center">
            <i class="fa fa-quote-left fa-3x card-img-top rounded-circle" aria-hidden="true"><img src="../src/assets/quote-svgrepo-com.svg"></img></i>
            <div class="card-body blockquote">
              <p class="card-text">Super easy to book, and the professionals are always on time! My house has never looked cleaner. PickAPro is a lifesaver!</p>
              <footer class="blockquote-footer" id="who_said"><cite title="Source Title">Ananya Gupta</cite></footer>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card border-light bg-light text-center">
            <i class="fa fa-quote-left fa-3x card-img-top rounded-circle" aria-hidden="true"><img src="../src/assets/quote-svgrepo-com.svg"></img></i>
            <div class="card-body blockquote">
              <p class="card-text">Used PickAPro for appliance repair. The technician was knowledgeable, friendly, and fixed my washing machine in no time. Highly recommend!</p>
              <footer class="blockquote-footer"><cite title="Source Title">Rohan Mehra</cite></footer>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card border-light bg-light text-center">
            <i class="fa fa-quote-left fa-3x card-img-top rounded-circle" aria-hidden="true"><img src="../src/assets/quote-svgrepo-com.svg"></img></i>
            <div class="card-body blockquote">
              <p class="card-text">Best beauty service at home! I booked a facial and pedicure, and the professional was amazing. Will definitely be using PickAPro again!</p>
      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            We are dedicated to connecting you with trusted professionals for all your home service needs. From cleaning and maintenance to beauty and wellness, our network of skilled experts ensures quality, reliability, and convenience right at your doorstep.
            </p>
